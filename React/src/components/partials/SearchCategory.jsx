      ...
      <div className="bg-gray-200 border-white w-full border rounded-xl">
        ...
        <div className="flex flex-col sm:flex-row items-center h-auto sm:h-16 p-2 sm:p-0 w-full">
          ...
          <div className="relative rounded-l-xl flex items-center h-12 sm:h-full w-full sm:w-1/4 mb-2 sm:mb-0 bg-white">
            <select className="border bg-transparent rounded-l-xl h-full focus:outline-none text-gray-500 w-full pl-3 pr-8 text-lg">
          ...
          <div className="hidden sm:block h-10 border-gray-300 mx-0"></div>
          ...
          <div className="relative w-full sm:w-1/4 h-12 sm:h-full mb-2 sm:mb-0">
            ...
            <input
              ...
              className="border h-full focus:outline-none w-full pl-8 text-lg py-2"
              value={location}
