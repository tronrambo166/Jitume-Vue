        ...
        <div className="p-6 max-w-screen-xl mx-auto">
            ...
            <div className="mb-6">
                <p>
                    ...
                    mission is to bridge the gap between businesses and
                    investors, offering a secure, trusted environment that
                    encourages growth and mutual success.
                    <h2 className="text-xl mt-3">
                        <b>Our Approach</b>
                    </h2>
                    ...
                    their local markets. We offer robust tools to manage funding
                    ...
                    <br></br>
                    <h2 className="text-xl mt-3">
                        <b>Making an Investment</b>
                    </h2>
                    <b> 1. Select a Business: </b>
                    Once you've identified a promising business, follow the
                    steps outlined in the business profile to begin the
                    investment process.
                    <br></br>
                    <b> 2. Funding Process: </b>
                    Funds are transferred securely through our escrow system and
                    ...
                    <br></br>
                    <b> 2. Can I withdraw my investment? </b>
                    Investments are typically bound to the project milestones
                    outlined in each agreement. Withdrawals may be limited
