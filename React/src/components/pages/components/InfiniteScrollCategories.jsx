...
const HorizontalInfiniteScroll = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute right-0 top-[-10px] rounded-lg bottom-[-10px] w-16 sm:w-28 bg-gradient-to-l from-[#0f381ed3] to-transparent z-10 pointer-events-none hidden sm:block" />
