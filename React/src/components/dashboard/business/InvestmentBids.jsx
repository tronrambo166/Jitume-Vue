...
function InvestmentBids() {
    ...
    <span className="bg-yellow-500/50 text-[13px] text-gray-800 font- uppercase px-3 py-1 rounded-full">
        {bid.status}
    </span>
</td>
                                    ...
                                    {activeBids.map((bid) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-2 text-sm">
                                                <p className="bg-lime-500/50 rounded-full py-1  text-black text-[13px] text-center  uppercase ">
                                                    {" "}
                                                    {bid.status}{" "}
                                                </p>
                                            </td>
