      ...
      <div className="flex flex-col justify-between ml-8">
        <div>
          ...
          <h2 className="text-slate-700 text-2xl md:text-3xl font-bold font-sharp-grotesk mb-5">
            Why jitume is the right <br /> choice for your investment <br />{" "}
            goals
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-9">
              ...
              <div className="flex items-center space-x-3">
                <img src={wellSecure} alt="Well Secured" className="w-6 h-6" />
                <p className="text-base md:text-lg text-slate-700 font-semibold">
                  Well Secured
                </p>
              </div>
        ...
        {/* Button */}
        <button className="mt-6 w-[192px] h-[44px] px-[24px] py-[8px] gap-[8px] bg-green-800 text-white rounded-lg shadow-lg hover:bg-green-700 transition-opacity duration-300">
          Browse Businesses
        </button>
      </div>
        ...
        <div className="bg-gray-50 p-0.3 rounded-lg border border-gray-300 ">
          ...
          <div className="mt-3">
            <p className="text-[22px] md:text-[24px] text-slate-700 font-semibold ml-3">
              ...
              <span className="text-gray-700">reliable</span> <br /> Fund
              Raising
            </p>
            <img
              src={Imge4}
