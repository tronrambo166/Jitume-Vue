      ...
      >
        ...
        <div className='w-full md:w-auto space-y-4 px-[20px] md:pl-[34px] flex flex-col items-center md:items-start pt-8 md:pt-0'>
          ...
          <p className='text-center md:text-left text-[20px] md:text-[40px] text-white w-full md:w-[670px] leading-[28px] md:leading-[45px]'>
            Explore over 1000 investment opportunities across various business categories
          </p>
      ...
      <div className="mt-[20px] mx-auto px-[34px] text-white max-w-7xl">
        <div className="flex flex-wrap justify-between">
          <div className="mt-8 flex flex-col space-y-6 w-full md:w-auto">
            ...
            <input type="text" placeholder='someone@domain.com' className='w-full md:w-[350px] outline-white p-4 bg-white/10 h-[50px] rounded-xl' />
            <button className='text-white w-full md:w-[200px] px-3 py-2 rounded-lg bg-[#22C55E]'>Subscribe</button>
          </div>

          {/* Links Section */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10 md:mt-0">
            {["Investors", "Business", "About Us"].map((title, index) => (
              <div key={index}>
                <h3 
                ...
                >
                  ...
                  <img 
                    src={down} 
                    alt="Dropdown Icon" 
                    className={`ml-3 mt-[6px] h-2 w-3 transform transition-transform duration-200 ${openDropdown === index ? 'rotate-180' : 'rotate-0'} block lg:hidden`}
                    />
                </h3>
                {/* Dropdown Links */}
                <ul className={`space-y-3 ${openDropdown === index ? "block" : "hidden"} md:block`}>
                  {title === "Investors" && (
                    <>
        ...
        <div className="py-7 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-6 md:mt-0">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
              <img src={fb} width={45} height={30} alt="custom icon" className="object-contain" />
            </a>
            <a href="https://x.com" target="_blank" rel="noopener noreferrer">
              <img src={x} width={45} height={30} alt="x logo" className="object-contain" />
            </a>
            <a href="https://instagram.com" className="bg-white/10 p-2 rounded-full" target="_blank" rel="noopener noreferrer">
              <FaInstagram size={30} className="text-white" />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
              <img src={linkedin} width={44} height={30} alt="custom icon" className="object-contain" />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
              <div className="bg-white/10 px-[9px] py-[14px] rounded-full">
                <img src={icon3} width={30} height={30} alt="custom icon" className="object-contain" />
              </div>
            </a>
          </div>
        </div>
