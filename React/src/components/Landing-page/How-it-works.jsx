...
const HowItWorks = () => {
    const cards = [
        ...
        },
        {
            ...
            description:
                "Select the business category that fits your needs. Whether agriculture, renewable energy or arts & culture.",
            icon: (
                <img
                    src={category}
                    alt="Category Icon"
        ...
        },
        {
            ...
            description:
                "Browse through the top recommendations and choose the business that meets your exact requirements for quality and convenience.",
            icon: (
                <img
                    src={choose}
                    alt="Choose Icon"
        ...
        },
        {
            ...
            description:
                "Leverage our platform to grow your business visibility, increase foot traffic, and engage with local customers efficiently.",
            icon: (
                <img
                    src={growth}
                    alt="Growth Icon"
