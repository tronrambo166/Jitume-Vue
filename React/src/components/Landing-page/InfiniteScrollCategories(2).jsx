...
const HorizontalInfiniteScroll = () => {
  ...
  return (
    <div className="relative w-full lg:w-[80%] mt-3 mb-3 mx-auto">
      ...
      <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#0f381e] to-transparent z-10 pointer-events-none" />
