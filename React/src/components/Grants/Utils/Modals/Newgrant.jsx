...
export default function GrantApplicationModal({
    ...
    useEffect(() => {
        if (isUploading || matchScore !== null) {
    ...
    //         // If match score modal is open on mobile, don't close the main modal
    ...
    // Define this outside your return block
...
*/
                                        ...
                                        <div className="flex items-start gap-4 bg-green-50 border border-green-100 rounded-xl p-4 mb-6">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 leading-relaxed">
                                                    ...
                                                    milestones to demonstrate
                                                    how you'll strategically
                                                    utilize the grant funding
                                                    across your project
                                                    timeline. This helps
                                                    investors track your
                                                    progress and build trust in
                                                    your execution plan.
                                                </p>
                                            </div>
                                        </div>
  ...
  */}
                            ...
                            <div className="px-4 py-4 border-t border-gray-100 flex justify-between items-center bg-white">
                                {step > 1 ? (
                                    <button
                                        onClick={prevStep}
                                        className="px-4 py-3 text-gray-600 hover:text-gray-800 bg-gray-100 hover:bg-gray-200 rounded-xl shadow-sm border border-gray-200 transition-all duration-200 text-sm font-medium min-w-[80px] touch-manipulation"
                                    >
                                        Back
                                    </button>
                                ) : (
                                ...
                                {step < 4 ? (
                                    <button
                                        onClick={nextStep}
                                        className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white px-5 py-3 rounded-xl transition-all shadow-lg shadow-green-200 flex items-center font-medium text-sm min-w-[120px] justify-center touch-manipulation"
                                    >
                                        Next Step
                                    ...
                                    <button
                                        ...
                                        className={`bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white px-4 py-3 rounded-xl transition-all shadow-lg shadow-green-200 flex items-center font-medium text-sm min-w-[140px] justify-center touch-manipulation ${
                                            isSubmitting ||
                                            matchScore === null ||
                                            matchScore <= 50
                ...
                {/* Place this just before the closing </div> of your main modal */}
            </div>
            <div>
                <MatchScoreModal
                    open={showMatchModal}
