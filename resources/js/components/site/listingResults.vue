  ...
  <div class="flex items-center col-sm-6">
        ...
        <div class="mt-4 row flex-column-reverse flex-md-row">
            ...
            <div class="clear"></div>
                ...
                <div class="row">
                    <p class="ml-1 my-0 text-black  text-[15px] font-bold small">{{ count }} businesses found<!-- in your location --></p>
                </div>
                <!-- Price Filter -->
...
<div class="pt-2 pb-2">
    ...
    <div class="whitespace-nowrap  mb-2">
        <p class="mt-2 font-bold text-black">Yearly Turnover: <span class="font-normal">${{ result.y_turnover.toLocaleString() }}</span></p>
