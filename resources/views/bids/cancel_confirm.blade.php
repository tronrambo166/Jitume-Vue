...
>
    ...
    <div class="email-container">
        <div class="content" style="padding: 20px">
            ...
            >
                Hi,<br />Are you sure about cancelling this bid?
                With 'Ok', your
                commitment from Investment to business {{$business_name}} will be canceled & you'll be redirected to Tujitume.
            </p>

            <div class="w-full mx-auto mt-4 py-4 text-center">
            <a href="<?php echo config('app.api_url');?>CancelAssetBid/{{$bid_id}}/ok" 
            style="text-decoration:none;color:black;background:yellow;padding:10px;border-radius:5px;display: inline;width: 50%;margin: auto;margin-top: 20px;">
            OK</a>
